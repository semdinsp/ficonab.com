...
class FiconabTest < Test::Unit::TestCase
  ...
  def test_key_pages
   ...
   def test_technotes_pages
      pagelist=["bootstrapv3","ruby-databin-wolfram","wolfram-aws","wolfram-cron","wolfram-document","coffeescript","wolfram-cloud-email","wolfram-cloud-emailv2","nestacms-locales","resque","sendmail", "heroku","postgres", "postgres", "bunny-amqp","email-authentication"]
